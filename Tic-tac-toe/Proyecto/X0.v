    ...
    begin
        case(curr_state)
            ...
            COMPUTER:begin 
                ...
                begin 
                    next_state <= IDLE;
                    player2_turn <= 1'b1;// computer to player1 when PC=1
                end 
...
module X0 (
  ...
  // TicTacToe
  TicTacToe TicTacToe_i1 (
    .clk( s0 ),
    .reset( s1 ),
    .player1( s2 ),
    .player2( s3 ),
    .player1_posiciones( player1_posiciones ),
    .player2_posiciones( player2_posiciones ),
    .pos1( s4 ),
    .pos2( s5 ),
    .pos3( s6 ),
    .pos4( s7 ),
  ...
  assign pos9_0 = s12[0];
  assign pos9_1 = s12[1];
  assign winner_0 = s13[0];
  assign winner_1 = s13[1];
endmodule
